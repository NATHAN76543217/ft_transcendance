...
function changeSectionDisplayStatus(setDisplaySection: any, displaySection: any, sectionName: string) {
		switch (sectionName) {
	...
	function displayPendingRequests(displaySection: any, relation: IUserInterface, myId: string) {
	...
	function displayOnlineFriends(displaySection: any, relation: IUserInterface) {	// FAKE - For Testing
		if ((relation.relationshipType & UserRelationshipTypes.pending_first_second) &&	// a ajuster
		...
		return (
			<aside className='w-48 bg-neutral'>
				...
				<section className="border-b-2 border-gray-300">
					<button className="flex items-center justify-between w-full py-2 pr-4 bg-blue-100 " onClick={() => changeSectionDisplayStatus(setDisplaySection, displaySection, "pendingRequests")}>
						<i className={"pl-4 fas " + (displaySection.pendingRequests ? "fa-chevron-down" : "fa-chevron-right")}></i>
					...
					<ul>
						{contextValue.relationshipsList.map((relation) =>
							<div key={relation.name}>
								{displayPendingRequests(displaySection, relation, contextValue.myId)}
							</div>
						)}
					</ul>
				</section>
				<section className="border-b-2 border-gray-300">
					<button className="flex items-center justify-between w-full py-2 pr-4 bg-yellow-100" onClick={() => changeSectionDisplayStatus(setDisplaySection, displaySection, "inGameFriends")}>
						<i className={"pl-4 fas " + (displaySection.inGameFriends ? "fa-chevron-down" : "fa-chevron-right")}></i>
						<h3 className="text-lg text-center first-letter:uppercase">
							In game friends
						</h3>
					</button>
				...
				<section className="border-b-2 border-gray-300">
					<button className="flex items-center justify-between w-full py-2 pr-4 bg-green-100" onClick={() => changeSectionDisplayStatus(setDisplaySection, displaySection, "onlineFriends")}>
						<i className={"pl-4 fas " + (displaySection.onlineFriends ? "fa-chevron-down" : "fa-chevron-right")}></i>
						<h3 className="text-lg text-center first-letter:uppercase">
							Online friends
						</h3>
					</button>
				...
				<section className="border-b-2 border-gray-300">
					<button className="flex items-center justify-between w-full py-2 pr-4 bg-red-100" onClick={() => changeSectionDisplayStatus(setDisplaySection, displaySection, "offlineFriends")}>
						<i className={"pl-4 fas " + (displaySection.offlineFriends ? "fa-chevron-down" : "fa-chevron-right")}></i>
						<h3 className="text-lg text-center first-letter:uppercase">
							Offline friends
						</h3>
					</button>
