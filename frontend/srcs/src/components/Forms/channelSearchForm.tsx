...
type ChannelSearchProps = {
    onSubmit: (values: IChannelSearchFormValues) => void  // define function type
}

export default function SearchChannel(props: ChannelSearchProps) {
    //const [username, password] = useState();

    const { register, handleSubmit, formState: { errors } } = useForm<IChannelSearchFormValues>();
        ...
        <section className="flex flex-col max-w-sm p-4 m-auto mt-32 bg-neutral">
            ...
            <form onSubmit={handleSubmit(props.onSubmit)} className="py-4 pr-8">
                <div className="relative w-96">
                    <TextInput name="channelName" register={register} labelClass="bloc" inputClass=" left"></TextInput>
