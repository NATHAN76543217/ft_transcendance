...
function CustomButton({content, url, onClickFunctionId, argId, bg_color, bg_hover_color, dark_text, text_size} : CustomButtonProps){
    if (bg_hover_color === undefined) {
        bg_hover_color = bg_color + "-dark";
    }

    return (
        <button className={ "inline-block rounded-lg font-semibold py-1 mx-2 " +
